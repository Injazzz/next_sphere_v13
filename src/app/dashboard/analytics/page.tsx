...
async function getAnalyticsData(
  ...
  if (isLeader && teamId) {
    ...
    // Get documents for each team member
  ...
  // Mock revenue calculation (you should implement based on your business logic)
  const totalRevenue = completedDocuments.length * 1000; // Example: $1000 per completed document

  // Mock client satisfaction (you should get this from actual feedback/ratings)
...
// Helper function to calculate date ranges (60d for trend comparison)
